...
public class BackDoorView implements Observer
{
  ...
  public BackDoorView(  RootPaneContainer rpc, MiddleFactory mf, int x, int y )
  {
    ...
    theBtClear.addMouseListener(new MouseEvents(theBtClear));
    theBtQuery.addMouseListener(new MouseEvents(theBtQuery));
    theBtRStock.addMouseListener(new MouseEvents(theBtRStock));
